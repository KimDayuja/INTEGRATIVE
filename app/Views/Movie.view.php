...
<head>
    ...
    <link rel="stylesheet" href="<?= ROOT ?>css/movie.css">
    <link rel="stylesheet" href="<?= ROOT ?>css/hover.css">
    ...
    <nav class="navbar navbar-expand-lg container">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                <ul class="navbar-nav gap-3" id="nav-list">
                    <li class="nav-item">
...
<div class="base-color align-content-center" style="border-top: 1px solid #CCC830" id="footer-wrapper">
    <div>
        <blockquote class="blockquote mb-0">
            <footer class="m-auto mx-auto my-auto justify-content-center text-center">
                <div id="misc">
                ...
                <div class="d-flex mt-5 pt-5 justify-content-center ">
                    <?php echo '<h1 id="follow-us">Stay In Trend, Follow Us On:</h1>' ?>
                </div>

                <div id="socials" class="d-flex justify-content-center">
                ...
                <small id="credits">&copy; i<small style="font-size:1rem; color:#CCC830">M</small>ovie 2024</small>
            </footer>
        </blockquote>
    </div>
</div>
...
<script src="https://code.jquery.com/jquery-3.7.1.js" integrity="sha256-eKhayi8LEQwp4NKxN+CfCh+3qOVUtJn3QNZ0TciWLP4="
    crossorigin="anonymous"></script>
<script src="<?= ROOT ?>js/movie.js"></script>
</body>
